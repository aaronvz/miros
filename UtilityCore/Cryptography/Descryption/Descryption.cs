...
namespace UtilityCore.Cryptography
{
    public class Descryption
    {
        ...
        private static void OutputEncrypted(string inputFile, Stream outputStream, Keys encryptionKeys)
        {
        ...
        private static Stream ChainEncryptedOut(Stream outputStream,Keys m_encryptionKeys)
        {
        ...
        private static PgpSignatureGenerator InitSignatureGenerator(Stream compressedOut, Keys m_encryptionKeys)
        {
